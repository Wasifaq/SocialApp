...
public class AccountController(UserManager<AppUser> userManager, ITokenService tokenService) : BaseApiController
{
    ...
    private async Task SetRefreshTokenCookie(AppUser user)
    {
        ...
        await userManager.UpdateAsync(user); // Storing RefreshToken to DB

        var cookieOptions = new CookieOptions
        {
            HttpOnly =  true, // This cookie is not accessible by any javaScript including our own client application
            Secure = true, // Only sent over https not on http
    ...
    public async Task<ActionResult> Logout()
    {
        await userManager.Users
            ...
            .ExecuteUpdateAsync(setter => setter
                .SetProperty(t => t.RefreshToken, _ => null)
                .SetProperty(t => t.RefreshTokenExpiry, _ => null));
